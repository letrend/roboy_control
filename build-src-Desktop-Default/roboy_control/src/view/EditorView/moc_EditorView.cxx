...
#include "../../../../../src/roboy_control/src/view/EditorView/EditorView.h"
...
const QMetaObjectExtraData EditorView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EditorView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EditorView,
      qt_meta_data_EditorView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EditorView::getStaticMetaObject() { return staticMetaObject; }
...
void *EditorView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IObserver"))
        return static_cast< IObserver*>(const_cast< EditorView*>(this));
